#!/usr/bin/env bash
# Rechvix quickstart — macOS & Linux.
#
...
# updates) rechvix into ./rechvix and runs its installer.
#
# Usage:
...
# succeed, and an existing ./rechvix checkout is updated in place rather
# than clobbered.
set -euo pipefail
...
cd "$REPO_DIR"
echo "==> Installing and starting rechvix..."
$SUDO ./install.sh
